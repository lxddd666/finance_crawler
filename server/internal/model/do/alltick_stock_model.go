...
// AlltickStockModel is the golang structure of table hg_alltick_stock_model for DAO operations like Where/Data.
type AlltickStockModel struct {
	g.Meta            `orm:"table:hg_alltick_stock_model, do:true"`
	Id                interface{} // 主键
	Code              interface{} // 股票代码
