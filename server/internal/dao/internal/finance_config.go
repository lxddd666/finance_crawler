...
// FinanceConfigColumns defines and stores column names for the table hg_finance_config.
type FinanceConfigColumns struct {
	Id           string // 配置ID
	AlltickToken string // 配置分组
}

// financeConfigColumns holds the columns for the table hg_finance_config.
...
func NewFinanceConfigDao(handlers ...gdb.ModelHandler) *FinanceConfigDao {
